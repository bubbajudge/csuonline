        ...
        'fields'    => array(
            ...
            array(
             ...
             array(
                ...
                'type'   => 'info',
                'notice' => false,
                'title'  => __( '', 'minti-framework' ),
                'desc'   => __( '* The CSS written here will not be lost when you update the theme.<br/>
* Sometimes you need to add !important rule to overwrite the default value set by the theme, example: <strong>font-size: 18px !important;</strong>', 'minti-framework' )
            ),
