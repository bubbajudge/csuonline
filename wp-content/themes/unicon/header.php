...
<?php if(isset($minti_data['media_favicon']['url']) && ($minti_data['media_favicon']['url'] != "")) { ?><link rel="shortcut icon" href="<?php echo esc_url($minti_data['media_favicon']['url']); ?>"><?php } else { ?><link rel="shortcut icon" href="#" /><?php } ?>
...
<body <?php body_class('smooth-scroll'); ?> itemscope itemtype="https://schema.org/WebPage">
