...
class ManagerCallbacks
{
	...
	public function enable_plugin( $args )
	{
		?><label class="switch">
			...
			<span class="cb-slider round"></span></label>&nbsp;&nbsp;<span class="tooltip" title="<?php _e( 'Enable this Global Switch if you want to show last modified info on your posts. If you disable this, all outputs including shortcode stops immediately.', 'wp-last-modified-info' ); ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
		<?php
	}
