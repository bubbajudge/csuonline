...
final class ITSEC_Version_Management {
	...
	private function __construct() {
		...
		if ( version_compare( $GLOBALS['wp_version'], '5.5', '>=' ) ) {
			add_filter( 'auto_plugin_update_send_email', array( $this, 'maybe_enable_automatic_updates_debug_email' ) );
			add_filter( 'auto_theme_update_send_email', array( $this, 'maybe_enable_automatic_updates_debug_email' ) );
			add_filter( 'auto_plugin_theme_update_email', array( $this, 'filter_automatic_updates_debug_email' ) );
		} else {
